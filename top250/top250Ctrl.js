angular.module('top250Module', [])
    .controller('top250Ctrl', ['$scope', '$http','$routeParams','$location','myService', function ($scope, $http,$routeParams,$location,myService) {
        // $http({
        //     method: 'get',
        ...
        // $http.jsonp('https://api.douban.com/v2/movie/top250').then(function(res){
